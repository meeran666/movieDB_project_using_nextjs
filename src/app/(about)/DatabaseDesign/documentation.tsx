...
return result;
  ...
  const result = await db
    ...
    .orderBy(sql\`CASE WHEN main_table.title ilike \${title} THEN 1 ELSE 2 END ASC\`,desc(mainTable.title))
    .limit(limit)`;
  const codetemp = `console.log("sflaskfjlsfjl;sakfdlsjfjsldfjslflsflslfdskfsljflskflsfljssdfksjflsfkdjslfdsksldfjslkfjsfjsldkfj")`;
  return (
    <>
      <div className="p-3">
        ...
        <div className="text-xl">
          ...
          <div className="pb-7">
            ...
            (bigint), runtime integer, adult boolean, backdropPath (text),
            budget (bigint), homepage (text), imdbId (text), languageCode
            (varchar), originalTitle (text), overview (text), popularity (text),
            posterPath (text), tagline (text), productionCompanies (text),
            productionCountries (text), spokenLanguages (text), keywords:
            (text),
          </div>
          <div className="pb-7">
          ...
          <div className="pb-7">
            ...
            related query. From backend all the database query are handle by
            using drizzle orm with typescript. Drizzle orm checks structure and
            data types of all the api response from database server, it also
            simplify the writing of query.
          </div>
          <div className="pb-7">
            ...
            send to function which handle the connection of database and query
            to database. The code which handle this query is put inside the try
            catch statement for catching any error coming from database server
            during the execution of query.
          </div>
          <div className="pb-7 text-2xl">Movie List Query</div>
          <div className="pb-7">
            ...
            statement is used for selecting the id , title , release date
            columns of table.
          </div>
          <div className="pb-7">
            ...
            this statement is used for conditional clause in which column of
            title of main table is equal to wrapped_title(query parameter) and
          ...
          <div className="pb-7">
            <SyntaxHighlighter
              ...
              // codeTagProps={{
              //   style: {
              //     // Targets all <span> tags inside <code>
              //     overflowX: "hidden",

              //     backgroundColor: "red", // Red background for all spans
              //   },
              // }}
              language="javascript"
              style={atomDark}
          ...
          <div className="pb-7 text-2xl">Movie Detail Query</div>
          <div className="pb-7">
          ...
          <div className="pb-7 text-2xl">Similar Movie Query</div>
          <div className="pb-7">
