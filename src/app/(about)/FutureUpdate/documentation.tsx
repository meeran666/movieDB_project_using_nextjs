  ...
  return (
    <>
      ...
      <div className="text-xl">
        <div className="pb-7">
          This Ai search has 3 distinct parts. First part is showcasing six
          images of movie posters in grid like pattern. Second part is LLM text
          output which stream to the frontend. Third part is youtube video that
          is trailer of movie is integrated at the end.
          <div className="flex items-center justify-center">
            <div className="w-[min(40rem,100%)] items-center justify-center pt-7 pb-7">
              <img src="/AI_image.jpg" alt="" className={`h-auto w-full`} />
            </div>
          </div>
        </div>
        <div className="pb-7 text-3xl font-bold">Images</div>
        <div className="pb-7">
          ...
          and one as official movie poster used for advertisement. In frontend,
          it is put in grid system of 14 rows and 18 columns.
          <br />
          <br />
          Image urls does not send directly to backend from api of duckduckgo,
          it is a two step process. First step is two find the vqd code of
          images which found in response from the route
          <span className="text-blue-700">
            {" https://duckduckgo.com/?q=${encodeURIComponent(query)} "}
          </span>
          . This vqd repersent the unique value of image in web. This vqd code
          let you extract the images url from the web using the route
          <span className="text-blue-700">
            {
        ...
        <div className="pb-7 text-3xl font-bold">LLM Text </div>
        <div className="pb-7">
          The text response comes from the LLM deepseek-chat-v3.1 which is
          hosted by third party organization(OpenRouter). For managing the
          output and input of LLM i used langchain framework on backend. You can
          learn about the langchain frameword here
          <a
          ...
          {` "it is expert on topic of movies"`}, second section is the main
          prompt. Third section is defining variables used in promt.
          <br />
          <br />
          {`"token_number"`} and {`"max_token_number"`} are the variables which
          filled in prompt dynamically during execution, so the values of{" "}
          {`"token_number"`} and {`"max_token_number"`} is varies randomly
          between 35 to 50 and 85 to 100 respectively.
          <br />
          <br />
          ...
          <br />
          <br />
          <div className="pt-4 pb-4 text-2xl font-semibold">model</div>
          <div className="pb-2">
            This field accepts model name. The primary argument for specifying
            the model in ChatOpenAI in LangChain.js is the model parameter,
            which is passed during instantiation to determine the specific
          ...
          <div className="pt-4 pb-4 text-2xl font-semibold">apikey</div>
          <div className="pb-2">
            API key to use when making requests to OpenAI. Defaults to the value
            of OPENAI_API_KEY environment variable. This field is optional.
            <br />
            <br />
            ...
            which is useful if you need to use multiple keys or manage them
            outside of environment variables
            <br />
            <br />
            Second method is the standard and more secure approach, preventing
            your secret key from being hardcoded in your source files. The
          ...
          <div className="pt-4 pb-4 text-2xl font-semibold">streaming</div>
          <div className="pb-2">
          ...
          <div className="pb-2">
            ...
            mechanism for handling events during the execution of the model
            call. It allows you to log events, stream intermediate results, or
          ...
          <div className="pt-10 pb-5 text-2xl font-extrabold">
