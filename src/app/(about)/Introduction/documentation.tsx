    ...
    <>
      <div className="flex flex-col justify-center p-3">
        ...
        <div className="text-xl">
          ...
          <div className="pb-7">
            You can search any movie which has been released ever in history.
            You will get the list of detail which are release date, genre, is
            movie adult or not, runtime, budget, revenue, original language,
            Average vote, spoken language, production companies, production
            countries, homepage, keywords, tagline, original title of a
            particular movie you want to search. You will even get poster of
            movie and the synopsis.
          </div>
          <div className="pb-7">
            Searching is done by name of movie. In home page you will get the
            search box where you can type the movie name or you can even type
            the part of movie name you want to search. After searching you will
            get the list of movie name. From that list you can chose the movie
            name you want to chose and see the detail.
          </div>
          <div className="pb-7 text-3xl">Searching go Through</div>
          <div className="pb-7">
            Home page is a first page comes when you can open website
            moviemania. Home page contain navbar and fotter which is a part of
            every route layout and contains searchbox also.
          </div>
          ...
          <div className="pb-7">
            ...
            parameters which are index, title and release date in sequence. If
            you hover over the rows it will change color for indicating hover.
            List contain titles which contain the key search title not any other
          ...
          <div className="">
            All rows are links by clicking or touching the rows lets you reach
            to detail page route of that movie
          </div>
          <div className="flex items-center justify-center">
            <div className="w-[min(40rem,100%)] items-center justify-center pb-7">
              <img src="/desktop_home.png" alt="" className={`h-auto w-full`} />
          ...
          <div className="pb-7">
            First section contain original title of movie, release date, genre,
            is movie adult or not (if not Adult {`'PG'`} will be written if
            Adult then {`'Adult'`} will be written), Poster of movie.
          </div>
          <div className="pb-7">
          ...
          <div className="pb-7">
            ...
            movie poster with there movie title. These all are the links to
            reach there detail page. When you click on any poster or below title
            part it will take you to detail page.
          </div>
          <div className="flex items-center justify-center">
            <div className="w-[min(40rem,100%)] items-center justify-center pb-7">
              <img src="/desktop_home.png" alt="" className={`h-auto w-full`} />
