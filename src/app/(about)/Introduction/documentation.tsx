...
function Documentation() {
  return (
    <>
      <div className="pb-20 text-4xl font-bold">Introduction</div>
      <div className="pb-7">
      ...
      <div className="pb-7">
        ...
        adult or not, runtime, budget, revenue, original language, Average vote,
        spoken language, production companies, production countries, homepage,
        keywords, tagline, original title of a particular movie you want to
        search. You will even get poster of movie and the synopsis.
      </div>
      <div className="pb-20">
        Searching is done by name of movie. In home page you will get the search
        box where you can type the movie name or you can even type the part of
        movie name you want to search. After searching you will get the list of
        movie name. From that list you can chose the movie name you want to
        chose and see the detail.
      </div>
      <div className="pb-7 text-3xl font-bold">Searching go through</div>
      <div className="pb-15">
      ...
      <div className="pb-7">
        ...
        another option for you to serach, which is you could also put part of
        name or title of movie in search box. For searching a movie you have to
        click or touch on serach button or press enter which will trigger the
        sending of title of movie to backend, there it will search and send back
        the list of movies to frontend.
      </div>
      <div className="pb-7">
        List contains at most 50 movie name, every row contains three parameters
        which are index, title and release date in sequence. If you hover over
        the rows it will change color for indicating hover. List contain titles
        which contain the key search title not any other titles. Even if two or
        greater then two movie have same name you can identity by the release
        date to choose between different movies.
      </div>
      <div className="">
      ...
      <div className="pb-7">
        Forth section name is similar movies. This section contain similar movie
        poster with there movie title. These all are the links to reach there
