  ...
  const stream = new ReadableStream({
    async start(controller) {
      try {
        ...
        // The *Social Network*'s post-production was crucial. Editors **Kirk Baxter** and **Angus Wall** assembled the rapid-fire dialogue, creating a tense, rhythmic pace. The **Oscar-winning** score by **Trent Reznor** and **Atticus Ross** provided a dark, electronic soundscape. **Sound design** meticulously built the Harvard environments, while **color grading** established a cool, moody palette reflective of the film's themes.
        // <div style="width: 100%">
